...
public class EdibleMace extends ModSwordItem {
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		tooltip.add(new StringTextComponent(ColorCodes.gold + "Item Ability: ME SMASH HEAD"));
		tooltip.add(
				new StringTextComponent(ColorCodes.gray + "The next attack deals double damage and weakens animals."));
	}
