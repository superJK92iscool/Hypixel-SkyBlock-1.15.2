...
public class InkWand extends ModSwordItem {
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		tooltip.add(new StringTextComponent(ColorCodes.gold + "Item Ability: Ink Bomb"));
		tooltip.add(new StringTextComponent(
				ColorCodes.gray + "Shoot an ink bomb in front of you dealing 10000 damage and giving Blindless."));
	}
