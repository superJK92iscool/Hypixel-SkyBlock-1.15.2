...
import net.hypixel.skyblock.items.armor.ender.EnderSet;
...
public enum ModArmorMaterial implements IArmorMaterial {
	// Dungeon Armor Sets
	Adaptive("adaptive", new int[] { 45, 65, 85, 50 }), // Normal Armor Sets
	Angler("angler", new int[] { 10, 25, 40, 15 }), Bat_Person("bat_person", new int[] { 15, 25, 30, 15 }),
	Blaze("blaze", new int[] { 70, 110, 150, 80 }),
	// Helmets
	...
	Emerald("emerald", new int[] { 45, 75, 100, 50 }),
	Ender("ender",
			new int[] { EnderSet.boots_def, EnderSet.leggings_def, EnderSet.chestplate_def, EnderSet.helmet_def }),
	...
	Farm_Suit("farm_suit", new int[] { 15, 35, 40, 15 }),
	// Boots
	Farmer_Boots("farmer_boots", new int[] { 20, -1, -1, -1 }), Fish_Hat("fish_hat", new int[] { -1, -1, -1, 0 }),
	...
	Monster_Raider("monster_raider", new int[] { 100, 65, 50, 75 }), Mushroom("mushroom", new int[] { 0, 10, 10, 0 }), // Chestplates
	...
	Perfect5("perfect_5", new int[] { 170, 220, 240, 190 }),
	...
	PerfectA("perfect_a", new int[] { 270, 320, 340, 290 }), PerfectB("perfect_b", new int[] { 290, 340, 360, 310 }),
	PerfectC("perfect_c", new int[] { 310, 360, 380, 330 }),
	...
	Squid_Boots("squid_boots", new int[] { 0, -1, -1, -1 }), Squid_Hat("squid_hat", new int[] { -1, -1, -1, 0 }), // Leggings
	...
	Zombie_Hat("zombie_hat", new int[] { -1, -1, -1, 10 }),

	Zombie_Heart("zombie_heart", new int[] { -1, -1, -1, 0 }),
