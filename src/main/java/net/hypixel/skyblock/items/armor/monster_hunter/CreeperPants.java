...
public class CreeperPants extends ModArmorItem {
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		try {
			...
			tooltip.add(new StringTextComponent(ColorCodes.gold + "Item Ability: Detonate"));
			tooltip.add(new StringTextComponent(ColorCodes.gray + "Causes an explosion when dropping below 20% HP."));
